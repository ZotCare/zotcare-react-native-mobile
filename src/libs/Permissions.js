      ...
      hasPermission => {
        ...
        PermissionsAndroid.request(
          ...
          if (status === PermissionsAndroid.RESULTS.DENIED) {
            ToastAndroid.show(
              'READ_CONTACTS permission denied by user.',
              ToastAndroid.LONG,
            );
          } else if (status === PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN) {
            ToastAndroid.show(
              'READ_CONTACTS permission revoked by user.',
              ToastAndroid.LONG,
            );
          }
          callback(false);
    ...
    PermissionsAndroid.check(PermissionsAndroid.PERMISSIONS.RECORD_AUDIO).then(
      hasPermission => {
        ...
        PermissionsAndroid.request(
          ...
          if (status === PermissionsAndroid.RESULTS.DENIED) {
            ToastAndroid.show(
              'RECORD_AUDIO permission denied by user.',
              ToastAndroid.LONG,
            );
          } else if (status === PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN) {
            ToastAndroid.show(
              'RECORD_AUDIO permission revoked by user.',
              ToastAndroid.LONG,
            );
          }
          callback(false);
        ...
        PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.CAMERA).then(
          status => {
            ...
            if (status === PermissionsAndroid.RESULTS.DENIED) {
              ...
              ToastAndroid.show(
                'CAMERA permission revoked by user.',
                ToastAndroid.LONG,
              );
            }
            callback(false);
    ...
    PermissionsAndroid.check(
      ...
      PermissionsAndroid.request(
        ...
        if (status === PermissionsAndroid.RESULTS.DENIED) {
          ...
          ToastAndroid.show(
            'WRITE_EXTERNAL_STORAGE permission revoked by user.',
            ToastAndroid.LONG,
          );
        }
        callback(false);
  ...
  if (
    ...
    PermissionsAndroid.check(
      ...
      PermissionsAndroid.request(
        ...
        if (status === PermissionsAndroid.RESULTS.DENIED) {
          ToastAndroid.show(
            'SYSTEM_ALERT_WINDOW permission denied by user.',
            ToastAndroid.LONG,
          );
        } else if (status === PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN) {
          ToastAndroid.show(
            'SYSTEM_ALERT_WINDOW permission revoked by user.',
            ToastAndroid.LONG,
          );
        }
        callback(false);
  ...
  if (
    ...
    PermissionsAndroid.check(
      ...
      PermissionsAndroid.request(
        ...
        if (status === PermissionsAndroid.RESULTS.DENIED) {
          ToastAndroid.show(
            'USE_FULL_SCREEN_INTENT permission denied by user.',
            ToastAndroid.LONG,
          );
        } else if (status === PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN) {
          ToastAndroid.show(
            'USE_FULL_SCREEN_INTENT permission revoked by user.',
            ToastAndroid.LONG,
          );
        }
        callback(false);
