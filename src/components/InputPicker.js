...
export default class InputPicker extends React.PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      focused: false,
      wheelVisible: false,
      selectedItem: this.props.data.length>=8?4:this.props.data.length/2,
      firstTime: true,
      selectedRound: 0,
      searchText: "",
      selector: null
  ...
  render() {
    ...
    <RNPickerSelect
        ...
        />
      <TouchableOpacity  style={styles.surface2} onPress={() => {        
          ...
          inputPadding={16}
        />
        {(this.props.code===""||this.props.code===null)&&<Icon name="chevron-down" style={styles.icon} size={20} color={Colors.secondaryColor} />}
        </TouchableOpacity>        
      </View>
